...
SECRET_KEY = 'django-insecure-t5f*n7ael6b465d@)r9*crqg_=$%)ei3_12vox6&y6(6y=x$#6'
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PERMISSION_CLASSES': [
        'rest_framework.permissions.IsAuthenticated',  # Default: require auth for all endpoints
    ],
}
